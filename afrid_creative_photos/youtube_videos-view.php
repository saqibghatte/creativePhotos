                ...
                <div class='card mainCard shadow-sm mb-3'>
                    <div class='container-fluid'>
                        <div class='card-header d-flex flex-column flex-md-row align-tiems-center justify-content-md-between'>
                            <h3 class='h1 mb-md-0 mb-sm-3 text-center'><a href='youtube_videos' class='mr-3 btn btn-sm btn-sm btn-primary'><i class='fas fa-arrow-left'></i></a>Youtube_videos</h3>
                    ...
                    <div class='card-body'>
                        <div class='row'>
                            ...
                            <div class='col-sm-12 col-md-4 col-lg-4 col-xl-4'>
                                <div class='border border-light p-2 profile-item'>
                                    <div class='profile-item-label'>Link</div>
                                    <div class='profile-item-value' id='viewLINK'></div>
                                </div>
                            </div>
                            <div class='col-sm-12 col-md-4 col-lg-4 col-xl-4'>
                                <div class='border border-light p-2 profile-item'>
