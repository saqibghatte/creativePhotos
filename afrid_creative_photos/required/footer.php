 ...
 <footer class="footer px-5 pt-0">
     <div class="row align-items-center justify-content-lg-between">
         <div class="col-12 text-center">
             <div class="copyright text-center  text-muted">&copy; <?= date('Y') ?> | All rights reserved</div>
         </div>
     </div>
 </footer>
 ...
 <script src='assets/js/pipeline.min.js'></script>
 <script src="assets/js/required.min.js"></script>
 <?= $__GETSCRIPT ?>
 <script src='assets/js/jqueryTable.min.js'></script>
